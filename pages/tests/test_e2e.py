...
class TestEcommerceE2E:
    ...
    def test_login_success(self, driver):
        ...
        login_page.load()
        login_page.login("guillermo@test.com", "$2b$10$K6kLPHIl5hO6XvIHWt3hwO1tFtzptxF76ee1YaIi.AUxINMjRM.Fu")
    ...
    @pytest.mark.parametrize("producto, cantidad_esperada", [
        ("Bajo Electrico", 1),
        ("Guitarra Acústica de 12 cuerdas", 1),
        ("Guitarra Eléctrica Stratocaster Style", 1)
    ])
